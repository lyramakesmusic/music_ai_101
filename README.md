...
Literally just sample from them. Make some snares with Dance Diffusion. Paulstretch some weird Stable Audio outputs into a pad. Tune Musicgen on top loops. Send VR Bass loops through RVC Squidward and distort them. Make a Mariah Carey riddim remix with Demucs stems. You're a producer, you know what to do, just have fun!
